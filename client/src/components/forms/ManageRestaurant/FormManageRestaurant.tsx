...
const formSchema = z
  .object({
    ...
    menuItems: z.array(
      z.object({
        name: z.string().min(1, "Name submenu is required"),
        price: z.coerce.number().min(1, "Price submenu is required"),
      })
    ),
...
const FormManageRestaurant = ({ isLoading, onSave, restaurant }: FormManageRestaurantProps) => {
